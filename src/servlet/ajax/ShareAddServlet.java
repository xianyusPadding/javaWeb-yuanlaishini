			...
			if(s_content.isEmpty()){
				...
				if(sAction.insertShare(share)){
					...
					for(int i=0;i<shareList.size();i++){
						...
						.append("<li class='fl-href-comment'><a href='#1'>评论</a></li>")
						.append("<li><a href=''>赞("+s.getStartNum()+")</a></li>")
						.append("</ul>")
						.append("</div>")
						.append("</div>")
						 //评论
						.append("<div class='fl-comment' class='row' style='display: none;background: #B66F58;'>")
						.append("<div class='row' >")
						...
						.append("<input type='text' value='${s.s_id }' hidden='hidden'>")
						.append("</div>")
